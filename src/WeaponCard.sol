...
contract WeaponCard is ERC721, ERC721Enumerable, ERC721URIStorage {
    constructor() ERC721("Weapon Cards", "WC") {}
    uint256 private _tokenIdCounter;

    enum Class {
        wand, // priest, mage
        sword, // swordsman, king, demon
        staff, // priest, mage
        claymore, // king, sowrdman, demon
        grimore, // only the priest, mage and (magic people)
        crown // only the king and god class can use
    }
    struct Lore {
        string name;
        string tittle;
